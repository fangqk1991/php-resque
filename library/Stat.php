...
class Stat
{
	...
	{
		return (int)Resque::redis()->get('resque:stat:' . $stat);
	}
	...
	{
		return (bool)Resque::redis()->incrby('resque:stat:' . $stat, $by);
	}
	...
	{
		return (bool)Resque::redis()->decrby('resque:stat:' . $stat, $by);
	}
	...
	{
		return (bool)Resque::redis()->del('resque:stat:' . $stat);
	}
}